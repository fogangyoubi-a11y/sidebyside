...
const DRIVERS: DriverProfile[] = [
  {
    ...
    tripsCompleted: 142,
    yearsActive: 3,
    car: { model: 'Toyota Corolla', color: 'Blanc', plate: 'LT 4** AA', type: 'berline', year: 2020 },
    verified: true,
    trustLevel: 'premium',
  ...
  },
  {
    ...
    tripsCompleted: 89,
    yearsActive: 2,
    car: { model: 'Hyundai i10', color: 'Gris', plate: 'OU 7** BC', type: 'citadine', year: 2021 },
    verified: true,
    trustLevel: 'premium',
  ...
  },
  {
    ...
    tripsCompleted: 56,
    yearsActive: 1,
    car: { model: 'Renault Logan', color: 'Bleu', plate: 'LT 2** XY', type: 'berline', year: 2015 },
    verified: true,
    trustLevel: 'verified',
  ...
  },
  {
    ...
    tripsCompleted: 211,
    yearsActive: 5,
    car: { model: 'Toyota RAV4', color: 'Noir', plate: 'CE 9** ZZ', type: 'suv', year: 2022 },
    verified: true,
    trustLevel: 'premium',
    bio: 'Cinq années de covoiturage. Bagages volumineux acceptés. Climatisation puissante.',
  },
  {
    id: 'd5',
    ...
    tripsCompleted: 73,
    yearsActive: 2,
    car: { model: 'Suzuki Swift', color: 'Rouge', plate: 'OU 5** KL', type: 'citadine', year: 2017 },
    verified: false,
    trustLevel: 'basic',
